...
interface SummaryDao {
    ...
    @Query("SELECT videoId, title, thumbnailUrl, timestamp FROM summaries ORDER BY timestamp DESC")
    fun getHistoryItems(): androidx.paging.PagingSource<Int, com.skul9x.ytsummary.model.HistoryItem>
